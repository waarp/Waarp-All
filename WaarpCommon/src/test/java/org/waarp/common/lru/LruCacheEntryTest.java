...
abstract public class LruCacheEntryTest {
  ...
  abstract protected InterfaceLruCacheEntry<String> createCacheEntry(
  ...
  public void getValueTest() {
    InterfaceLruCacheEntry<String> cacheEntry = createCacheEntry(value, ttl);
  ...
  public void expirationTimeTest() throws InterruptedException {
    InterfaceLruCacheEntry<String> cacheEntry = createCacheEntry(value, 10);
