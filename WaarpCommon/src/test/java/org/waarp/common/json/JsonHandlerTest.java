...
public class JsonHandlerTest {
  ...
  public void testCreateObjectNode() {
    ...
    assertTrue(Arrays.equals("bytes".getBytes(), JsonHandler
        .getValue(node, "bytes", " ".getBytes())));
  ...
  public void extraTest() {
    ...
    test = test.replace("'", "\"");
    ObjectNode node2 = JsonHandler.getFromString(test);
    assertTrue(node2 != null);
    String test2 = JsonHandler.writeAsString(node2);
    assertTrue(test.equals(test2));
    Map<String, Object> map = JsonHandler.getMapFromString(test);
    assertTrue(map != null);
  }
