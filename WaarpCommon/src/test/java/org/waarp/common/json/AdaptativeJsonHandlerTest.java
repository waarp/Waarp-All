...
public class AdaptativeJsonHandlerTest {
  ...
  private static AdaptativeJsonHandler handler =
  ...
  public void testCreateObjectNode() {
    ...
    assertTrue(Arrays.equals("bytes".getBytes(),
  ...
  public void extraTest() {
    ...
    test = test.replace("'", "\"");
    ObjectNode node2 = handler.getFromString(test);
    assertTrue(node2 != null);
    String test2 = handler.writeAsString(node2);
    assertTrue(test.equals(test2));
    Map<String, Object> map = handler.getMapFromString(test);
    assertTrue(map != null);
  }
}
