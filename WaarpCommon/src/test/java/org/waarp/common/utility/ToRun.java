...
public final class ToRun {
  ...
  public static class ToRunShutdownHook extends WaarpShutdownHook {
    ...
    protected void exitService() {
      System.out.println(
          "Interruption on going for PID: " + JvmProcessId.jvmProcessId());
    }
  }

  public static void main(String[] args) throws InterruptedException {
    System.out.println("PID is " + JvmProcessId.jvmProcessId());
    ShutdownConfiguration shutdownConfiguration = new ShutdownConfiguration();
    shutdownConfiguration.timeout = 100;
    ToRunShutdownHook toRunShutdownHook =
