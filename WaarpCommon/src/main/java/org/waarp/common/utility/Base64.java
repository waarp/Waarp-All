...
public class Base64 {
      ...
      // the provided class loader.
        ...
        ois = new ObjectInputStream(bais) {
          ...
          public Class<?> resolveClass(ObjectStreamClass streamClass)
              throws IOException, ClassNotFoundException {
            final Class<?> c =
                Class.forName(streamClass.getName(), false, loader);
            if (c == null) {
  ...
  public static void encodeToFile(byte[] dataToEncode, String filename)
    ...
    try {
      bos = new OutputStream(new FileOutputStream(filename), ENCODE);
  ...
  public static void decodeToFile(String dataToDecode, String filename)
    ...
    OutputStream bos = null;
    try {
      bos = new OutputStream(new FileOutputStream(filename), DECODE);
