...
/**
 * A skeletal implementation of {@link WaarpLogger}. This class implements
 * all methods that have a {@link WaarpLogLevel} parameter by default to call
...
public abstract class AbstractWaarpLogger implements WaarpLogger, Serializable {
    ...
    @Override
    public void log(final WaarpLogLevel level, final String msg, final Throwable cause) {
        switch (level) {
            case TRACE:
                trace(msg, cause);
                break;
    ...
    @Override
    public void log(final WaarpLogLevel level, final String format, final Object arg) {
        switch (level) {
            case TRACE:
                trace(format, arg);
                break;
    ...
    @Override
    public void log(final WaarpLogLevel level, final String format, final Object argA, final Object argB) {
        switch (level) {
            case TRACE:
    ...
    @Override
    public void log(final WaarpLogLevel level, final String format, final Object... arguments) {
        switch (level) {
            case TRACE:
