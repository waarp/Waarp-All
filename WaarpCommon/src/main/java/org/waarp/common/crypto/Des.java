...
public class Des extends KeyObject {
   ...
   */
  private static final int KEY_SIZE = 56; // [32..448]
  private static final String ALGO = "DES";
  private static final String INSTANCE = "DES/ECB/PKCS5Padding";
  public static final String EXTENSION = "des";
