...
public class FtpDataInitializer extends ChannelInitializer<SocketChannel> {
  ...
  protected static final FtpDataTypeCodec ftpDataTypeCodec =
      new FtpDataTypeCodec(TransferType.ASCII, TransferSubType.NONPRINT);

  protected static final FtpDataStructureCodec ftpDataStructureCodec =
  ...
  public void initChannel(final SocketChannel ch) throws Exception {
    ...
    pipeline.addLast(CODEC_LIMIT, configuration.getFtpInternalConfiguration()
