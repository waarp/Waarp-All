...
Les blocs `<task>` definissent les tâches opérées par les différents acteurs de la règle
  ...
  .. option:: type
    ...
    *nonEmptyString*
    ...
    Type de tâche: LOG, MOVE, MOVERENAME, COPY, COPYRENAME, EXEC, EXECMOVE, EXECOUTPUT, EXECJAVA,
    TRANSFER, VALIDFILEPATH, DELETE, LINKRENAME, RESCHEDULE, TAR, ZIP, TRANSCODE, SNMP, FTP
