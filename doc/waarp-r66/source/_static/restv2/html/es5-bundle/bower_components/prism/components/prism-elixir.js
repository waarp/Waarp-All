Prism.languages.elixir={comment:{pattern:/#.*/m,lookbehind:!0/* ignoreName */ /* skipSlots */},// ~r"""foo""" (multi-line), ~r'''foo''' (multi-line), ~r/foo/, ~r|foo|, ~r"foo", ~r'foo', ~r(foo), ~r[foo], ~r{foo}, ~r<foo>
