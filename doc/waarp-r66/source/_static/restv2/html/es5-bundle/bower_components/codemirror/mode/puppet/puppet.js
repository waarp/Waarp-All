...
return{startState:function startState(){var state={inDefinition:!1,inInclude:!1,continueString:!1,pending:!1};return state},token:function token(stream,state){// Strip the spaces, but regex will account for them eitherway
