...
mod(CodeMirror)})(function(CodeMirror){"use strict";CodeMirror.defineMode("spreadsheet",function(){return{startState:function startState(){return{stringType:null,stack:[]}},token:function token(stream,state){if(!stream)return;//check for state changes
