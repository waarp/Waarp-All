...
token:function token(stream,state){var style=void 0,match;// Return value of pattern matches.
...
style="tlv-m4"}}return style},indent:function indent(state){return!0==state.tlvCodeActive?state.tlvNextIndent:-1},startState:function startState(state){state.tlvIndentationStyle=[];// Styles to use for each level of indentation.
