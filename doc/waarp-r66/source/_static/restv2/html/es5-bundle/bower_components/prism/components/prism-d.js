Prism.languages.d=Prism.languages.extend("clike",{string:[// r"", x""
...
/\b0x\.?[a-f\d_]+(?:(?!\.\.)\.[a-f\d_]*)?(?:p[+-]?[a-f\d_]+)?[ulfi]*/i,{pattern:/((?:\.\.)?)(?:\b0b\.?|\b|\.)\d[\d_]*(?:(?!\.\.)\.[\d_]*)?(?:e[+-]?\d[\d_]*)?[ulfi]*/i,lookbehind:!0/* ignoreName */ /* skipSlots */}],// In order: $, keywords and special tokens, globally defined symbols
...
pattern:/(^|[^\\])\/\+(?:\/\+[\s\S]*?\+\/|[\s\S])*?\+\//,lookbehind:!0}].concat(Prism.languages.d.comment);Prism.languages.insertBefore("d","comment",{"token-string":{// Allow one level of nesting
