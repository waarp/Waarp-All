...
class HuffmanCompressor {
  ...
  public static int compress4streams(final Object outputBase,
    ...
    // first segment
    compressedSize =
        compressSingleStream(outputBase, output, (int) (outputLimit - output),
    ...
    UnsafeUtil.UNSAFE.putShort(outputBase, outputAddress + SIZE_OF_SHORT,
    ...
    compressedSize =
        compressSingleStream(outputBase, output, (int) (outputLimit - output),
                             inputBase, input, (int) (inputLimit - input),
                             table);
    if (compressedSize == 0) {
      return 0;
    }
  ...
  public static int compressSingleStream(final Object outputBase,
                                         final long outputAddress,
                                         final int outputSize,
                                         final Object inputBase,
                                         final long inputAddress,
    ...
    switch (inputSize & 3) {
      case 3:
        table.encodeSymbol(bitstream, UnsafeUtil.UNSAFE.getByte(inputBase,
                                                                inputAddress +
                                                                n + 2) & 0xFF);
        // fall-through
      case 2:
