...
class FrameHeader {
  ...
  public FrameHeader(final long headerSize, final int windowSize,
                     final long contentSize, final long dictionaryId,
                     final boolean hasChecksum) {
  ...
  public String toString() {
    return FrameHeader.class.getSimpleName() + "[headerSize=" + headerSize +
           ", windowSize=" + windowSize + ", contentSize=" + contentSize +
           ", dictionaryId=" + dictionaryId + ", hasChecksum=" + hasChecksum +
           "]";
  }
}
