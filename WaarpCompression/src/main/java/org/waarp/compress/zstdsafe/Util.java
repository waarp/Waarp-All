...
final class Util {
  ...
  public static void verify(final boolean condition, final int offset,
                            final String reason) {
    if (!condition) {
  ...
  public static MalformedInputException fail(final int offset,
                                             final String reason) {
    throw new MalformedInputException(offset, reason);
  }
  ...
  public static void put24BitLittleEndian(final byte[] outputBase,
                                          final int outputAddress,
                                          final int value) {
    putShort(outputBase, outputAddress, (short) value);
