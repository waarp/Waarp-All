...
class BlockCompressionState {
  ...
  public BlockCompressionState(final CompressionParameters parameters,
    ...
    chainTable = new int[1 << parameters
        .getChainLog()]; // TODO: chain table not used by Strategy.FAST
  }
  ...
  public void enforceMaxDistance(final int inputLimit, final int maxDistance) {
    final int distance = inputLimit - baseAddress;
