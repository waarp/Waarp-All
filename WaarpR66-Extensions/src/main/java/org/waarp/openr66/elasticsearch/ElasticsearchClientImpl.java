...
public class ElasticsearchClientImpl implements ElasticsearchClient {
  private static final WaarpLogger logger =
      WaarpLoggerFactory.getLogger(ElasticsearchClientImpl.class);
   ...
   */
  public ElasticsearchClientImpl(final String username, final String pwd,
    ...
    if (ParametersChecker.isNotEmpty(apiKey)) {
      defaultHeaders[headerLen] =
