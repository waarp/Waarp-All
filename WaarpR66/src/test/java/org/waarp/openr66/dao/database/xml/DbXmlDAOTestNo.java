...
public abstract class DbXmlDAOTestNo extends DBAllDAOTest {
  ...
  public void initDB() {
    // Init through Map
    try {
      XMLLimitDAO dao = new XMLLimitDAO(path);
      dao.deleteAll();
      dao.insert(new Limit("server1", 1, 2, 3, 4, 5,
                                UpdatedInfo.valueOf(1)));
      dao.insert(new Limit("server2", 2, 3, 2, 2, 2,
                                UpdatedInfo.valueOf(0)));
      dao.insert(new Limit("server3", 5, 6, 3, 4, 3,
                                UpdatedInfo.valueOf(0)));
    } catch (DAOConnectionException e) {
      e.printStackTrace();
    }
    try {
      XMLBusinessDAO dao = new XMLBusinessDAO(path);
      dao.deleteAll();
    } catch (DAOConnectionException e) {
      e.printStackTrace();
    }
...
*/
    ...
    try {
      XMLHostDAO dao = new XMLHostDAO(path);
      dao.deleteAll();
    ...
    try {
      XMLRuleDAO dao = new XMLRuleDAO(path);
      dao.deleteAll();
    } catch (DAOConnectionException e) {
      e.printStackTrace();
    }
    ...
    */
    ...
    try {
      XMLTransferDAO dao = new XMLTransferDAO(path);
      dao.deleteAll();
    } catch (DAOConnectionException e) {
      e.printStackTrace();
    }
