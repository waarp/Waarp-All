...
/**
 * ElasticsearchMonitoringExporterClient Factory (only available in JRE 8 and over and if a
 * Factory is set into ElasticsearchMonitoringExporterClientBuilder)
 */
public interface ElasticsearchMonitoringExporterClientFactory {
   ...
   *
   * @return a new ElasticsearchMonitoringExporterClient
   */
  ElasticsearchMonitoringExporterClient createElasticsearchClient(
