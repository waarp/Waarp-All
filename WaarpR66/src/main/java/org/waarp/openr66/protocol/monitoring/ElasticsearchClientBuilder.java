...
/**
 * Builder of ElasticsearchClientFactory
 */
public class ElasticsearchClientBuilder {
  ...
  public static final String ELASTICSEARCH_CLIENT_FACTORY_IMPL =
      "org.waarp.openr66.elasticsearch.ElasticsearchClientFactoryImpl";
  ...
  static {
    ...
    try {
      ...
      factory = (ElasticsearchClientFactory) WaarpSystemUtil
  ...
  /**
   * Set from JRE8 or greather with a valid ElasticsearchClientFactory
   *
   * @param factoryToSet
   */
  public static void setFactory(final ElasticsearchClientFactory factoryToSet) {
    factory = factoryToSet;
  }

  /**
   * @return the current ElasticsearchClientFactory
   *
   * @throws IllegalArgumentException if no Factory is setup
   */
  public static ElasticsearchClientFactory getFactory() {
    if (factory == null) {
