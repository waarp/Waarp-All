...
public enum R66FiniteDualStates {
  ...
  private enum R66Transition {
    ...
    tAUTHENTD(AUTHENTD,
              EnumSet.of(REQUESTR, VALIDOTHER, INFORMATION, SHUTDOWN, TEST,
                         ...
                         ERROR)),
    tREQUESTR(REQUESTR, EnumSet.of(VALID, REQUESTD, ERROR, CLOSEDCHANNEL)),
    tREQUESTD(REQUESTD, EnumSet.of(VALID, DATAS, DATAR, ENDTRANSFERS, ERROR)),
    tVALID(VALID, EnumSet.of(REQUESTD, DATAR, DATAS, ENDTRANSFERS, ENDTRANSFERR,
                             CLOSEDCHANNEL, ERROR)),
    tDATAS(DATAS, EnumSet.of(DATAS, ENDTRANSFERS, VALID, ERROR)),
    tDATAR(DATAR, EnumSet.of(DATAR, ENDTRANSFERS, ENDTRANSFERR, ERROR)),
    tENDTRANSFERS(ENDTRANSFERS, EnumSet.of(ENDTRANSFERR, VALID, ERROR)),
    ...
    tCLOSEDCHANNEL(CLOSEDCHANNEL,
                   EnumSet.of(CLOSEDCHANNEL, ERROR, ENDREQUESTR, ENDREQUESTS)),
    tBUSINESSR(BUSINESSR,
               EnumSet.of(ERROR, BUSINESSD, CLOSEDCHANNEL, VALIDOTHER)),
    tBUSINESSD(BUSINESSD, EnumSet.of(ERROR, BUSINESSD, BUSINESSR, CLOSEDCHANNEL,
                                     VALIDOTHER));
  ...
  private static final ConcurrentHashMap<R66FiniteDualStates, EnumSet<R66FiniteDualStates>>
      stateMap =
      new ConcurrentHashMap<R66FiniteDualStates, EnumSet<R66FiniteDualStates>>();
