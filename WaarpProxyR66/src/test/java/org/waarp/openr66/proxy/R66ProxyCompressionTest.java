...
public class R66ProxyCompressionTest extends CommonUtil {
  @Rule(order = Integer.MIN_VALUE)
  public TestWatcher watchman = new TestWatcherJunit4();
  private static final String CONFIG_CLIENT_B_XML_COMP =
      "config-clientB-compression.xml";
  private static final String CONFIG_SERVER_A_MINIMAL_XML_COMP =
      "config-serverA-minimal-compression.xml";
  ...
  public static void launchConfig() throws Exception {
    ...
    CONFIG_SERVER_A_MINIMAL_XML = CONFIG_SERVER_A_MINIMAL_XML_COMP;
    CONFIG_CLIENT_B_XML = CONFIG_CLIENT_B_XML_COMP;
    useCompression = true;
    launchServers();
  }
