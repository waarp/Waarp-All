 ...
 *
 */
public class HttpHttpInitializer extends ChannelInitializer<SocketChannel> {
   ...
   *
   */
  public HttpHttpInitializer(HttpPageHandler httpPageHandler) {
  ...
  protected void initChannel(SocketChannel ch) throws Exception {
    ...
    pipeline.addLast(executor, "handler",
                     new HttpRequestTestHandler("/tmp", "mycookie",
                                                httpPageHandler));
  }
